...
add wave -noupdate -format Literal -radix hexadecimal -expand /cpu/i1/i3/data0
add wave -noupdate -format Literal /cpu/i1/i6/cacheline1
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {80475 ns}
WaveRestoreZoom {0 ns} {2631 ns}
